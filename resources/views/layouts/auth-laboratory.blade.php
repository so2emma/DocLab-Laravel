            ...
            <div class="container">
                ...
                <div class="dropdown pe-0 pe-md-5">
                    <a class="btn btn-outline-secondary dropdown-toggle" href="#" role="button"
                        ...
                        {{ Auth::guard('laboratory')->user()->name }}
                    </a>

                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">Profile</a></li>
                        <form id="logout-form" action="{{ route('laboratory.logout') }}" method="POST"
                            style="display: none;">
                            @csrf
                        </form>
                        <li><a class="dropdown-item" href="{{ route('laboratory.logout') }}"
